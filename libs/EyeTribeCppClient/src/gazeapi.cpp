...
namespace gtl
{
    ...
    public:
        ...
        void calibration_clear()
        {
            ...
            std::cout << "send: " << "{\"category\":\"calibration\",\"request\":\"clear\"}" << std::endl;
        }

        void calibration_abort()
        {
            send( "{\"category\":\"calibration\",\"request\":\"abort\"}" );
            std::cout << "send: " << "{\"category\":\"calibration\",\"request\":\"abort\"}" << std::endl;
        }
        ...
        void calibration_point_end()
        {
            ...
            std::cout << "send: " << "{\"category\":\"calibration\",\"request\":\"pointend\"}" << std::endl;
        }
